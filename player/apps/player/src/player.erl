...
% message_dealer/1: Ova funkcija prima jedan argument Msg, za koji se očekuje da je poruka koju želite poslati dealer gen_serveru.
% Koristi rpc:call/4 za sinkrono slanje poruke dealer gen_serveru na čvoru specificiranom s ?DEALER makro. Poruka se šalje pozivanjem funkcije primjer/1 na dealer gen_serveru s Msg kao argumentom.
% Povratna vrijednost rpc:call/4 je povratna vrijednost funkcije primjer/1 na dealer gen_serveru, što je string
message_dealer(Msg)->
